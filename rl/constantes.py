...
ERROR_MOTOR_ONE_NOT_ORIGIN = "motor one not origin"
ERROR_MOTOR = "motor out of range"

_ORIG_EPSILON_ = 2100
EPSILON_MOTOR_1 = {DEGREE: dynToDeg(_ORIG_EPSILON_), 
                   RADIAN: dynToRad(_ORIG_EPSILON_), 
                   DYNAMIXEL: _ORIG_EPSILON_
                   }
...
HUMIDITY_IN_MIN = 40 # percent
HUMIDITY_IN_MAX = 70 # percent

HUMIDITY_OUT_MIN = 50 # percent
HUMIDITY_OUT_MAX = 80 # percent
HUMIDITY_STEP = 10 # %

ATMOSPHERIC_PRESSURE_MIN = 850 # hPa
ATMOSPHERIC_PRESSURE_MAX = 1050 # hPa
ATMOSPHERIC_PRESSURE_THRESHOLD = 1015 # hPa
...
REWARD_GOOD_EMOTION = 2

REWARD_SAME_EMOTION_DISTRIBUTION = 5
REWARD_NOT_SAME_EMOTION_DISTRIBUTION = -3

REWARD_NOT_MOVING = -2
REWARD_MOVING = 3

REWARD_MOTOR_OUT = -5
REWARD_MOTOR_CHANGING = 3
